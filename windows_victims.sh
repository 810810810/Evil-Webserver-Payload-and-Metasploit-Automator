...
start_server() {
  ...
  echo "<html><head><title>Downloading payload...</title><meta http-equiv=\"refresh\" content=\"0; url=/downloads/$PAYLOAD_NAME\"></head><body><p>Downloading payload...</p></body></html>" | sudo tee /var/www/html/downloads/index.html
